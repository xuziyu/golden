...
<script>
	...
	function edit(id) {
		...
		window.location.href = 'edit.action?cuserId=' + id;
	}
	//----------------------------------------------3方法名和url参/数--------------------------------------
	function deletem(id) {
		...
		$.ajax({
			async : true, //是否异步
			type : "post",
			url : 'deleteAj.action?cuserId=' + id,
	...
	<div id="toolbar">
		<form id='formAreaQuery'>
			<div style="padding: 6px; padding-top: 15px;">
				...
				<span>信用积分:</span>
				<input id="creditPoint" style="height: 20px; border: 1px solid #ccc">
				
				<span>会员积分:</span>
				<input id="memberPoint" style="height: 20px; border: 1px solid #ccc">
	...
	<table id="dgArea" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'userId',width:180,align:'center'">用户名</th>
				<th data-options="field:'creditPoint',width:200,align:'center'">信用积分</th>
				<th data-options="field:'memberPoint',width:200,align:'center'">会员积分</th>
