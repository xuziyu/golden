...
<script>
	...
	function deletem(id) {
		...
		$.ajax({
			async : true, //是否异步
			type : "post",
			url : 'deleteAj.action?tradeId=' + id,
	...
	<div id="toolbar">
		<form id='formAreaQuery'>
			<div style="padding: 6px; padding-top: 15px;">
				<span>银行卡号:</span>
				<input id="cardId" style="height: 20px; border: 1px solid #ccc">
				
				<span>类型:</span>
				<input id="tradeType" style="height: 20px; border: 1px solid #ccc">
	...
	<table id="dgArea" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'cardId',width:180,align:'center'">银行卡号</th>
				<th data-options="field:'tradeType',width:200,align:'center'">类型</th>
				<th data-options="field:'tradeMoney',width:200,align:'center'">余额</th>
